...
#define SHORT_LAND_MSG printf ("Hamurabi, think again."\
  " You own only %d acres. Now then,\n", acres)
#define SHORT_GRAIN_MSG printf ("Hamurabi, think again."\
  " You have only %d bushels of grain. Now then,\n", grain)

int pop, acres, grain, starved, born, yield, rats, food, year;

void resign (void) {
  printf ("Hamurabi, I can not do what you wish."
