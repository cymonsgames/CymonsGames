// Rover Wars by Joseph Larson 18-Dec-2009
...
int SCREENW = 800;
int SCREENH = 600;
// Rover Wars specific stuff goes here.
...
void mainmenu() {
  while (!key[KEY_SPACE] && !key[KEY_ENTER]&& !key[KEY_ESC]) {
    ...
    textprintf_centre_ex(screen, font, SCREENW / 2, 80, makecol(255,255,255), makecol(0,0,0), "ROVER WARS");
