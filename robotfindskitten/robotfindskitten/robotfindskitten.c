...
int main(int argc, char *argv[])
{
  ...
  for (c = 2; c < COLORS; c++) init_pair(c, c, COLOR_BLACK);
	...
	/* This is to dynamicly allocate the screen space.
	 * COLS and LINES have no meaning before initscr() is called so they can't be used to define a global variable or a variable in main(). */
