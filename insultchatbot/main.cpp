...
bool quit = false;
  ...
  "   The Insult Chat Bot by Pavle Mihajlovic and its code is a \n"
  "   2008 Cymon's Games game.\n"
  ...
  "Please type anything in the prompt.\n";
while (quit == false)
	{
	string sent;
	cout << "> ";
	...
	for (int a = 0; a != words.size(); a++)
		{
		if (words [a] == "HI" || words [a] == "HELLO" || words [a] == "HEY"
		  || words [a] == "HAI")
			{
		...
		else if (words[a] == "YOU" && a != words.size()-1
		  && (words[a+1] == "ARE" || words[a+1] == "RE"))
			{
			cout << "YOUR MOM IS";
